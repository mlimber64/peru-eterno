...
android {
    ...
    compileOptions {
        // Requerido por flutter_local_notifications (v10+): usa APIs de
        // java.time que en Android antiguos solo existen vía desugaring.
        // Sin esto el build falla aunque no se programe ni una notificación.
